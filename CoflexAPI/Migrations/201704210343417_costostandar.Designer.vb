...
Namespace Migrations
    ...
    Public NotInheritable Partial Class costostandar
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(costostandar))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201704210343417_costostandar"
            End Get
        End Property
